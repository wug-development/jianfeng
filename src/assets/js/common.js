...
if ($(document).ready(function() {
	...
	/*var mySound = new Audio("./media/bg.mp3");
	mySound.loop = !0,
	mySound.play(),
...
/*$.getScript("./js/webgl_ea9cb39.js",function(){}),*/
$("body").addClass("webglyes")) : (tryPgvSendClick(ismobile ? {
